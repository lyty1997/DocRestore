...
class ImagePreprocessor:
    ...
    def __init__(
        ...
        self._image_token_id: int = self._tokenizer.vocab[
            self._image_token
        ]
    ...
    def bos_id(self) -> int:
        """BOS token id"""
        token_id: int = self._tokenizer.bos_token_id
        return token_id

    @property
    def eos_id(self) -> int:
        """EOS token id"""
        token_id: int = self._tokenizer.eos_token_id
        return token_id

    @property
    def pad_id(self) -> int:
        """PAD token id"""
        token_id: int = self._tokenizer.pad_token_id
        return token_id
    ...
    def preprocess(
        ...
        input_ids = input_ids.unsqueeze(0)  # type: ignore[assignment]
