...
该脚本只生成给 Codex/人工查看的预览图，不作为算法输入。

用法：
    python3 .codex/skills/view-gel-image/scripts/compress_for_preview.py <dir>
    python3 .codex/skills/view-gel-image/scripts/compress_for_preview.py <file>
    LONG_EDGE=1536 python3 .codex/skills/view-gel-image/scripts/compress_for_preview.py ...
"""
