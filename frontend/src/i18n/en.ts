...
export const en: Record<TranslationKey, string> = {
  ...
  "crop.noBoxHint": "No sidebars detected; this image is not cropped by default.",
  "crop.addBox": "Crop manually",
  "crop.removeBox": "Don't crop this image",
  ...
  "codeViewer.liveDiagnosticError": "Live syntax check failed",
  "codeViewer.diagnosticsTitle": "Current diagnostics ({count})",
  "codeViewer.acceptDiagnostic": "Accept diagnostic",
  "codeViewer.clearAcceptedDiagnostics": "Restore accepted diagnostics",
  "codeViewer.acceptedDiagnostics": "{count} diagnostic(s) accepted",
