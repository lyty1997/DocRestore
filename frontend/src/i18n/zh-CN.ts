...
export const zhCN = {
  ...
  "codeViewer.liveDiagnosticError": "实时语法检查失败",
  "codeViewer.diagnosticsTitle": "当前诊断 ({count})",
  "codeViewer.acceptDiagnostic": "接受此诊断",
  "codeViewer.clearAcceptedDiagnostics": "恢复已接受诊断",
  "codeViewer.acceptedDiagnostics": "已接受 {count} 条诊断",
  ...
  "figureCrop.quadHint": "把 4 个角点分别拖到插图的左上 / 右上 / 右下 / 左下角，确认后自动旋转 + 透视校正为正视图。",  "figureCrop.confirm": "裁剪并插入",
